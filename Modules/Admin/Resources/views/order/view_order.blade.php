                    ...
                    @foreach ($order_detail as $detail)
                        ...
                        <tr class="color_qty_{{ $detail->product_id }}">
                                        ...
                                        <td width="12%">
                                            ...
                                            @if($status!=2) 
                                            <button style="padding:0;; margin-left: 10px" data-product_id="{{ $detail->product_id }}" class="btn btn-default update_quantity" name="update_quantity"><i style="font-size: 22px; color:blue" class="fas fa-edit"></i></button>
                                            @endif
                                        </td>
